...
def get_scans(
    base_dir, area, split, min_displacement: float = 0.0
...
def generate_evaluation_set(
    dataset_root: str, area: str, min_displacement: float = 0.0, dist_threshold=5
) -> EvaluationSet:
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Generate evaluation sets for UGV dataset"
    )
    parser.add_argument(
        "--dataset_root",
        type=str,
        required=False,
        default="/data/raktim/Datasets/ALITA/VAL",
    )
